...
class CategoriesServiceTest {
    ...
    fun should_order_categories_by_title() {
        //Given
        val category1 = Category(id = 1, title = "edc", type = CategoryType.BOOKS, apiLink = "href1")
        val category2 = Category(id = 2, title = "abc", type = CategoryType.CHARACTERS, apiLink = "href2")
        val category3 = Category(id = 3, title = "zbc", type = CategoryType.HOUSES, apiLink = "href2")
    ...
    fun should_not_return_unknown_categories_when_get_categories_is_call() {
        //Given
        val category1 = Category(id = 1, title = "edc", type = CategoryType.BOOKS, apiLink = "href1")
        val category2 = Category(id = 2, title = "abc", type = CategoryType.UNKNOWN, apiLink = "href2")
        val category3 = Category(id = 3, title = "zbc", type = CategoryType.HOUSES, apiLink = "href2")
        given(repository.getCategories(false)).willReturn(Single.just(listOf(category1, category2, category3)))
